...
# Updates: Concatenate output files
...
for no_databases1 in database:
	...
	if data_split[0] == "BWA":
		...
		concate_files = concate_files +namefile_o
		concate_files = concate_files +"_*_spt/*.bwa."
		...
		concate_files = concate_files +"/"
		concate_files = concate_files +namefile_o
		concate_files = concate_files +"_*_spt/*"
		...
		lst_samfiles = lst_samfiles +namefile_o
		lst_samfiles = lst_samfiles +"_*_spt/*"
		lst_samfiles = lst_samfiles +"."
...
concatloc = "cat " + cdir
concatloc = concatloc +"/"
concatloc = concatloc +namefile_o
concatloc = concatloc +"_*_spt/*"
